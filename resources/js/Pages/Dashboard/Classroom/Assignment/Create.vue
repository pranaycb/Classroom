...
const submit = () => form.post(route('dashboard.classroom.assignments.store', props.room.code), {
    preserveScroll: true,
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-10 col-xl-8">
                    ...
                    <div class="p-4" style="border: 2px dashed var(--border-color);">
                        ...
                        <p class="small">Fillup the below form to create an assignment</p>
                        ...
                        <form class="row gy-4" @submit.prevent="submit">
                            ...
                            <div class="col-12">
                                <PrimaryButton text="Create Assignment" :block="true" :showLoader="form.processing"
