...
const submit = () => {
    form.post(route('dashboard.classroom.exams.questions.store', [props.room.code, props.exam.id]), {
        preserveScroll: true,
        onSuccess: (e) => {
            form.reset('question');
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    ...
                    <div class="p-4" style="border: 2px dashed var(--border-color);">
                        ...
                        <p class="small">Fillup the below form to create question</p>
                        ...
                        <form class="row gy-4" @submit.prevent="submit">
                            ...
                            <div class="col-12">
                                <PrimaryButton text="Create Question" :block="true" :showLoader="form.processing"
