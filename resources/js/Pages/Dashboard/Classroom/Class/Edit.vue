...
const submit = () => {
    form.put(route('dashboard.classroom.online-classes.update', [props.room.code, props.data.id]), {
        preserveScroll: true,
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    ...
                    <div class="p-4" style="border: 2px dashed var(--border-color);">
                        ...
                        <h5>Update Class</h5>
                        <p class="small">Fillup the below form to update class</p>
                        ...
                        <form class="row gy-4" @submit.prevent="submit">
                            ...
                            <div class="col-12">
                                <PrimaryButton text="Upddate Class" :block="true" :showLoader="form.processing"
