...
const submit = () => form.post(route('dashboard.classroom.online-classes.store', props.room.code), {
    preserveScroll: true,
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    ...
                    <div class="p-4" style="border: 2px dashed var(--border-color);">
                        ...
                        <h5>Create Class</h5>
                        <p class="small">Fillup the below form to schedule an online class</p>
                        ...
                        <form class="row gy-4" @submit.prevent="submit">
                            ...
                            <div class="col-12">
                                <PrimaryButton text="Create Class" :block="true" :showLoader="form.processing"
